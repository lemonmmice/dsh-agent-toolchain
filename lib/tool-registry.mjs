 ...
 *     perf_report/heap/analyze（读已存在的 dump）、hang_status/packs/pack、memory_search/recall/status、
 ...
 *     perf_probe/dump/trace/hotstacks/clean（起采样器/冻屏/删证据）、hang_run/stop/analyze/delete
